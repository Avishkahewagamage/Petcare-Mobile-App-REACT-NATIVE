...
const Flash2 = ({ navigation }) => {
  return (
    <View style={styles.container}>
      <Image
        source={require('../assets/Flash2.png')} // Ensure this path is correct
      ...
      <View style={styles.buttonContainer}>
        ...
        <TouchableOpacity 
          ...
          onPress={() => navigation.navigate('HomeScreen')} // Navigate to HomeScreen on press
        >
...
const styles = StyleSheet.create({
  ...
  petsImage: {
    width: '100%',
    height: 478, // Adjust height as per your image dimensions
    resizeMode: 'cover',
    marginBottom: 0, // Remove unnecessary margin properties
    marginTop: 0,
  },
  title: {
    fontSize: 24,
