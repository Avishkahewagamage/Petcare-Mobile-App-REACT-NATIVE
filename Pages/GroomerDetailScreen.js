...
const GroomerDetailScreen = ({ route }) => {
  ...
  const handleAppointment = () => {
    if (selectedDate && selectedTime) {
      Alert.alert(
        ...
        `You have successfully booked a grooming session with ${groomer.name} on ${selectedDate} at ${selectedTime}.`
      );
    } else {
      Alert.alert('Error', 'Please select a date and time for your grooming session.');
    }
  };
    ...
    <Background>
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity onPress={() => makeCall(groomer.phoneNumber)} style={styles.iconButton}>
      ...
      <Card containerStyle={styles.card}>
        <Card.Title style={styles.cardTitle}>{groomer.name}</Card.Title>
        <Card.Divider />
        <Text style={styles.specialty}>{groomer.description}</Text>
        <View style={styles.specialtyContainer}>
          <Text style={styles.specialtyText}>Specialty:</Text>
          <Text style={styles.specialtyTag}>{groomer.description}</Text>
        </View>
