...
const VeterinarianDetailScreen = ({ route }) => {
  ...
  const handleAppointment = () => {
    if (selectedDate && selectedTime) {
      Alert.alert(
        ...
        `You have successfully booked an appointment with ${veterinarian.name} on ${selectedDate} at ${selectedTime}.`
      );
    } else {
    ...
    <Background>
      <View style={styles.header}>
        ...
        <View style={styles.headerActions}>
          <TouchableOpacity onPress={() => makeCall(veterinarian.phoneNumber)} style={styles.iconButton}>
      ...
      <Card containerStyle={styles.card}>
        <Card.Title style={styles.cardTitle}>{veterinarian.name}</Card.Title>
        <Card.Divider />
        <Text style={styles.specialty}>{veterinarian.description}</Text>
        <View style={styles.specialtyContainer}>
          <Text style={styles.specialtyText}>Specialty:</Text>
          <Text style={styles.specialtyTag}>{veterinarian.description}</Text>
        </View>
